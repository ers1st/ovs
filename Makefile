...
bin_PROGRAMS = utilities/ovs-appctl$(EXEEXT) \
	...
	utilities/ovs-openstate$(EXEEXT) utilities/ovs-vsctl$(EXEEXT) \
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/sset.c lib/sset.h lib/state-table.c lib/state-table.h \
	lib/stp.c lib/stp.h lib/stream-fd.h lib/stream-provider.h \
	lib/stream-ssl.h lib/stream-tcp.c lib/stream.c lib/stream.h \
	lib/stdio.c lib/string.c lib/svec.c lib/svec.h lib/table.c \
	lib/table.h lib/tag.c lib/tag.h lib/timer.c lib/timer.h \
	lib/timeval.c lib/timeval.h lib/token-bucket.c \
	lib/token-bucket.h lib/type-props.h lib/unaligned.h \
	lib/unicode.c lib/unicode.h lib/unixctl.c lib/unixctl.h \
	lib/util.c lib/util.h lib/uuid.c lib/uuid.h lib/valgrind.h \
	lib/vconn-provider.h lib/vconn-stream.c lib/vconn.c \
	lib/vconn.h lib/vlan-bitmap.c lib/vlan-bitmap.h lib/vlandev.c \
	lib/vlandev.h lib/vlog.c lib/vlog.h lib/vswitch-idl.c \
	lib/vswitch-idl.h lib/vtep-idl.c lib/vtep-idl.h \
	lib/daemon-windows.c lib/getopt_long.c lib/getrusage-windows.c \
	lib/latch-windows.c lib/route-table-stub.c lib/strsep.c \
	lib/stream-fd-windows.c lib/daemon-unix.c lib/latch-unix.c \
	lib/signals.c lib/signals.h lib/stream-fd-unix.c \
	lib/stream-unix.c lib/dpif-linux.c lib/dpif-linux.h \
	...
	lib/netdev-dpdk.c lib/netdev-dpdk.h lib/async-append-aio.c \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/sset.lo lib/state-table.lo lib/stp.lo lib/stream-tcp.lo \
	lib/stream.lo lib/stdio.lo lib/string.lo lib/svec.lo \
	lib/table.lo lib/tag.lo lib/timer.lo lib/timeval.lo \
	lib/token-bucket.lo lib/unicode.lo lib/unixctl.lo lib/util.lo \
	lib/uuid.lo lib/vconn-stream.lo lib/vconn.lo \
	lib/vlan-bitmap.lo lib/vlandev.lo lib/vlog.lo \
...
utilities_ovs_ofctl_DEPENDENCIES = ofproto/libofproto.la \
	lib/libopenvswitch.la
am_utilities_ovs_openstate_OBJECTS =  \
	utilities/ovs-openstate.$(OBJEXT)
utilities_ovs_openstate_OBJECTS =  \
	$(am_utilities_ovs_openstate_OBJECTS)
utilities_ovs_openstate_DEPENDENCIES = lib/libopenvswitch.la
...
SOURCES = $(lib_libopenvswitch_la_SOURCES) \
	...
	$(utilities_ovs_openstate_SOURCES) \
...
am__noinst_HEADERS_DIST = BUILD.Windows CONTRIBUTING CodingStyle \
	...
	IntegrationGuide NOTICE OPENFLOW-1.1+ PORTING README.md \
	README-lisp REPORTING-BUGS TODO .travis.yml .travis/build.sh \
	.travis/prepare.sh WHY-OVS boot.sh build-aux/cccl \
...
ACLOCAL = ${SHELL} /home/davide/Scrivania/Tesi/ovs-openstate/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/davide/Scrivania/Tesi/ovs-openstate/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/davide/Scrivania/Tesi/ovs-openstate/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /home/davide/Scrivania/Tesi/ovs-openstate/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /home/davide/Scrivania/Tesi/ovs-openstate/build-aux/missing automake-1.14
AWK = gawk
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/davide/Scrivania/Tesi/ovs-openstate/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/davide/Scrivania/Tesi/ovs-openstate
abs_srcdir = /home/davide/Scrivania/Tesi/ovs-openstate
abs_top_builddir = /home/davide/Scrivania/Tesi/ovs-openstate
abs_top_srcdir = /home/davide/Scrivania/Tesi/ovs-openstate
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/davide/Scrivania/Tesi/ovs-openstate/build-aux/install-sh
...
EXTRA_DIST = BUILD.Windows CONTRIBUTING CodingStyle DESIGN FAQ INSTALL \
	...
	OPENFLOW-1.1+ PORTING README.md README-lisp REPORTING-BUGS \
	TODO .travis.yml .travis/build.sh .travis/prepare.sh WHY-OVS \
...
lib/state-table.lo: lib/$(am__dirstamp) lib/$(DEPDIR)/$(am__dirstamp)
...
utilities/ovs-openstate.$(OBJEXT): utilities/$(am__dirstamp) \
	utilities/$(DEPDIR)/$(am__dirstamp)

utilities/ovs-openstate$(EXEEXT): $(utilities_ovs_openstate_OBJECTS) $(utilities_ovs_openstate_DEPENDENCIES) $(EXTRA_utilities_ovs_openstate_DEPENDENCIES) utilities/$(am__dirstamp)
	@rm -f utilities/ovs-openstate$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(utilities_ovs_openstate_OBJECTS) $(utilities_ovs_openstate_LDADD) $(LIBS)
utilities/ovs-vlan-bug-workaround.$(OBJEXT):  \
...
include lib/$(DEPDIR)/state-table.Plo
...
include utilities/$(DEPDIR)/ovs-openstate.Po
